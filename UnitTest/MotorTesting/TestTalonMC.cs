...
namespace UnitTest
{
    ...
    public class TestTalonMC
    {
        ...
        {
            TestablePWMOutput TestPWMOutput = new TestablePWMOutput();
            LowPass<float> TestLPF = new LowPass<float>(SteadyStateEpsilon: 0.4);
